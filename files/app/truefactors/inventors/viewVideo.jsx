			...
			<div className="container">
				...
				{Root.lib.spinAnchor(me, 'AB')}
					...
					{Root.commUI.show({
							...
							<button type="button" className="btn btn-warning  m-1 border border-default pull-right" onClick={me.setCurrentVideo.bind(me, null)}>Play Section (5 - 15 secs)</button>
							<button type="button" className="btn btn-warning  m-1 border border-default pull-right" onClick={me.setCurrentVideo.bind(me, null)}>Programming Play</button>
							</span>), 
							setting : {
